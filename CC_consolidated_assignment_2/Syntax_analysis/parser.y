...
additive_exp:
        additive_exp ADD multiplicative_exp     {printf("ADD\n");}
        |   additive_exp SUB multiplicative_exp {printf("SUB\n");}
        |   multiplicative_exp                  
        ;
...
switch_case_list:
        switch_case {printf("Here1\n");}
        |  switch_case_list switch_case  {printf("Here\n");}       
        ;
 
switch_case:
        CASE constant COLON loop_stat_list   {printf("Here2\n");}
        |   DEFAULT COLON loop_stat_list   {printf("Here3\n");}
        ;

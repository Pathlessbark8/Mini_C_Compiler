...
plist: COMMA ID {
                    ...
                    printf("Name is %s\n", $2.name);
                    printf("Arjun Type is %s\n", get_type($2.name));
                    printf("FormatSpecifierList[currentPrintfArgumentIndex] is %d\n", FormatSpecifierList[currentPrintfArgumentIndex]);
    ...
    | COMMA ID LSQBRACKET ID RSQBRACKET LSQBRACKET ID RSQBRACKET {
                                                                if(check_declaration($2.name)==0 && isArray($2.name)==1){
                                                                    printf("Error: Undeclared variable %s\n", $2.name);
                                                                    exit(1);
                                                                }
                                                                if(check_declaration($4.name)==0 && isArray($4.name)==0){
                                                                    printf("Error: Undeclared variable %s\n", $4.name);
                                                                    exit(1);
                                                                }
                                                                if(check_declaration($7.name)==0 && isArray($7.name)==0){
                                                                    printf("Error: Undeclared variable %s\n", $7.name);
                                                                    exit(1);
                                                                }
                                                                if(currentPrintfArgumentIndex>=FormatSpecifierListIndex){
    ...
    | COMMA ID LSQBRACKET NUMBER RSQBRACKET LSQBRACKET ID RSQBRACKET {
                                                                if(check_declaration($2.name)==0 && isArray($2.name)==1){
                                                                    printf("Error: Undeclared variable %s\n", $2.name);
                                                                    exit(1);
                                                                }
    ...
    | COMMA ID LSQBRACKET ID RSQBRACKET LSQBRACKET NUMBER RSQBRACKET {
                                                                if(check_declaration($2.name)==0 && isArray($2.name)==1){
                                                                    printf("Error: Undeclared variable %s\n", $2.name);
                                                                    exit(1);
                                                                }
    ...
    | COMMA ID LSQBRACKET NUMBER RSQBRACKET LSQBRACKET NUMBER RSQBRACKET {
                                                                if(check_declaration($2.name)==0 && isArray($2.name)==1){
                                                                    printf("Error: Undeclared variable %s\n", $2.name);
                                                                    exit(1);
                                                                }
